...
namespace Bolt\Extension\Europeana\FrontendExt;
...
{    
    ...
    const NAME = 'FrontendExt';
    /** @var string Extension's container */
    const CONTAINER = 'extensions.FrontendExt';
	...
	public static function sortlisting(\Bolt\Application $app, $contenttypeslug)
	{
